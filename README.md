...
Here we show results of a models consisting of a Resnet50 backbone followed by Generalized Mean Layer. The models are trained with eithher the standard triplet loss or the Bayesian triplet loss. All models are trained withh standard hard negative mining on image resolution 224x224.
